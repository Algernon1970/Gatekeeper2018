...
Partial Public Class ZuulDataSet
    ...
    Partial Public Class Tbl_PrinterDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overloads Function AddTbl_PrinterRow(ByVal Name As String, ByVal ConnectionString As String, ByVal Make As String, ByVal Model As String, ByVal IPAddress As String, ByVal parentTbl_LocationRowByFK_Tbl_Printer_Tbl_Location As Tbl_LocationRow) As Tbl_PrinterRow
            Dim rowTbl_PrinterRow As Tbl_PrinterRow = CType(Me.NewRow,Tbl_PrinterRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, Name, ConnectionString, Make, Model, IPAddress, Nothing}
...
Namespace ZuulDataSetTableAdapters
    ...
    Partial Public Class Lnk_ComputerInfoTableAdapter
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.Middleman2018.My.MySettings.Default.ZuulConnectionString
        End Sub
    ...
    Partial Public Class Lnk_ComputerPrinterTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1).CommandText = "SELECT        ID, ComputerID, PrinterID"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            Lnk_ComputerPrinter"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHE"& _ 
                "RE        (ComputerID = @ComputerID)"
        ...
        Public Overloads Overridable Function GetPrinterIDByComputerID(ByVal ComputerID As Integer) As ZuulDataSet.Lnk_ComputerPrinterDataTable
    ...
    Partial Public Class Tbl_ComputerTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Tbl_Computer] ([Name], [InventoryNumber], [SerialNumber], [Mak"& _ 
                "e], [Model], [RamGB], [HDDGB], [SSD], [Location]) VALUES (@Name, @InventoryNumbe"& _ 
                "r, @SerialNumber, @Make, @Model, @RamGB, @HDDGB, @SSD, @Location);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Compu"& _ 
                "terID, Name, InventoryNumber, SerialNumber, Make, Model, RamGB, HDDGB, SSD, Loca"& _ 
                "tion FROM Tbl_Computer WHERE (ComputerID = SCOPE_IDENTITY())"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Tbl_Computer] SET [Name] = @Name, [InventoryNumber] = @InventoryNum"& _ 
                ...
                " @RamGB, [HDDGB] = @HDDGB, [SSD] = @SSD, [Location] = @Location WHERE (([Compute"& _ 
                ...
                "riginal_SSD)) AND ([Location] = @Original_Location));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT ComputerID, Name, "& _ 
                "InventoryNumber, SerialNumber, Make, Model, RamGB, HDDGB, SSD, Location FROM Tbl"& _ 
                "_Computer WHERE (ComputerID = @ComputerID)"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ComputerID, Name, InventoryNumber, SerialNumber, Make, Model, RamGB, HDDGB"& _ 
                ", SSD, Location FROM dbo.Tbl_Computer"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT ComputerID, Name, InventoryNumber, SerialNumber, Make, Model, RamGB, HDDGB"& _ 
                ", SSD, Location FROM dbo.Tbl_Computer Where Name = @ComputerName"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@ComputerName", Global.System.Data.SqlDbType.NVarChar, 50, Global.System.Data.ParameterDirection.Input, 0, 0, "Name", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        End Sub
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Insert, true)>  _
        Public Overloads Overridable Function Insert(ByVal Name As String, ByVal InventoryNumber As String, ByVal SerialNumber As String, ByVal Make As String, ByVal Model As String, ByVal RamGB As Global.System.Nullable(Of Integer), ByVal HDDGB As Global.System.Nullable(Of Integer), ByVal SSD As Global.System.Nullable(Of Boolean), ByVal Location As Integer) As Integer
        ...
        Public Overloads Overridable Function Update( _
            ...
            Me.Adapter.UpdateCommand.Parameters(9).Value = CType(Original_ComputerID,Integer)
            If (Original_Name Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_Name")
            Else
            ...
            If (Original_RamGB.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(20).Value = CType(Original_RamGB.Value,Integer)
            Else
            ...
            If (Original_HDDGB.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(22).Value = CType(Original_HDDGB.Value,Integer)
            Else
            ...
            If (Original_SSD.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(24).Value = CType(Original_SSD.Value,Boolean)
            Else
                Me.Adapter.UpdateCommand.Parameters(23).Value = CType(1,Object)
                Me.Adapter.UpdateCommand.Parameters(24).Value = Global.System.DBNull.Value
            End If
            Me.Adapter.UpdateCommand.Parameters(25).Value = CType(Original_Location,Integer)
            Me.Adapter.UpdateCommand.Parameters(26).Value = CType(ComputerID,Integer)
            Dim previousConnectionState As Global.System.Data.ConnectionState = Me.Adapter.UpdateCommand.Connection.State
            If ((Me.Adapter.UpdateCommand.Connection.State And Global.System.Data.ConnectionState.Open)  _
                        <> Global.System.Data.ConnectionState.Open) Then
                Me.Adapter.UpdateCommand.Connection.Open
        ...
        Public Overloads Overridable Function Update( _
                    ...
                    ByVal Original_HDDGB As Global.System.Nullable(Of Integer),  _
                    ByVal Original_SSD As Global.System.Nullable(Of Boolean),  _
                    ByVal Original_Location As Integer) As Integer
            Return Me.Update(Name, InventoryNumber, SerialNumber, Make, Model, RamGB, HDDGB, SSD, Location, Original_ComputerID, Original_Name, Original_InventoryNumber, Original_SerialNumber, Original_Make, Original_Model, Original_RamGB, Original_HDDGB, Original_SSD, Original_Location, Original_ComputerID)
        End Function
    End Class
    ...
    Partial Public Class Tbl_InfoTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT InfoID, DateStamp, Title, Notes FROM dbo.Tbl_Info where Title = @Title"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], false)>  _
        Public Overloads Overridable Function GetInfoByTitle(ByVal Title As String) As ZuulDataSet.Tbl_InfoDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
    ...
    Partial Public Class Tbl_PrinterTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Tbl_Printer] ([Name], [ConnectionString], [Make], [Model], [IP"& _ 
                "Address], [Location]) VALUES (@Name, @ConnectionString, @Make, @Model, @IPAddres"& _ 
                "s, @Location);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT PrinterID, Name, ConnectionString, Make, Model, IPAddress"& _ 
                ", Location FROM Tbl_Printer WHERE (PrinterID = SCOPE_IDENTITY())"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Name", Global.System.Data.SqlDbType.NVarChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "Name", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Tbl_Printer] SET [Name] = @Name, [ConnectionString] = @ConnectionSt"& _ 
                ...
                "Location WHERE (([PrinterID] = @Original_PrinterID) AND ([Name] = @Original_Name"& _ 
                ") AND ([ConnectionString] = @Original_ConnectionString) AND ((@IsNull_Make = 1 A"& _ 
                "ND [Make] IS NULL) OR ([Make] = @Original_Make)) AND ((@IsNull_Model = 1 AND [Mo"& _ 
                "del] IS NULL) OR ([Model] = @Original_Model)) AND ((@IsNull_IPAddress = 1 AND [I"& _ 
                "PAddress] IS NULL) OR ([IPAddress] = @Original_IPAddress)) AND ((@IsNull_Locatio"& _ 
                "n = 1 AND [Location] IS NULL) OR ([Location] = @Original_Location)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Pr"& _ 
                "interID, Name, ConnectionString, Make, Model, IPAddress, Location FROM Tbl_Print"& _ 
                "er WHERE (PrinterID = @PrinterID)"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Name", Global.System.Data.SqlDbType.NVarChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "Name", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT PrinterID, Name, ConnectionString, Make, Model, IPAddress, Location FROM d"& _ 
                "bo.Tbl_Printer"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT ConnectionString FROM Tbl_Printer where PrinterID = @PrinterID"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Insert, true)>  _
        Public Overloads Overridable Function Insert(ByVal Name As String, ByVal ConnectionString As String, ByVal Make As String, ByVal Model As String, ByVal IPAddress As String, ByVal Location As Global.System.Nullable(Of Integer)) As Integer
            If (Name Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Name")
            Else
                Me.Adapter.InsertCommand.Parameters(0).Value = CType(Name,String)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal Name As String, ByVal ConnectionString As String, ByVal Make As String, ByVal Model As String, ByVal IPAddress As String, ByVal Location As Global.System.Nullable(Of Integer), ByVal Original_PrinterID As Integer, ByVal Original_Name As String, ByVal Original_ConnectionString As String, ByVal Original_Make As String, ByVal Original_Model As String, ByVal Original_IPAddress As String, ByVal Original_Location As Global.System.Nullable(Of Integer), ByVal PrinterID As Integer) As Integer
            If (Name Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Name")
            Else
                Me.Adapter.UpdateCommand.Parameters(0).Value = CType(Name,String)
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(5).Value = Global.System.DBNull.Value
            End If
            Me.Adapter.UpdateCommand.Parameters(6).Value = CType(Original_PrinterID,Integer)
            If (Original_Name Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_Name")
            Else
            ...
            If (Original_ConnectionString Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_ConnectionString")
            Else
                Me.Adapter.UpdateCommand.Parameters(8).Value = CType(Original_ConnectionString,String)
            End If
            If (Original_Make Is Nothing) Then
                Me.Adapter.UpdateCommand.Parameters(9).Value = CType(1,Object)
                Me.Adapter.UpdateCommand.Parameters(10).Value = Global.System.DBNull.Value
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(16).Value = Global.System.DBNull.Value
            End If
            Me.Adapter.UpdateCommand.Parameters(17).Value = CType(PrinterID,Integer)
            Dim previousConnectionState As Global.System.Data.ConnectionState = Me.Adapter.UpdateCommand.Connection.State
            If ((Me.Adapter.UpdateCommand.Connection.State And Global.System.Data.ConnectionState.Open)  _
                        <> Global.System.Data.ConnectionState.Open) Then
                Me.Adapter.UpdateCommand.Connection.Open
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal Name As String, ByVal ConnectionString As String, ByVal Make As String, ByVal Model As String, ByVal IPAddress As String, ByVal Location As Global.System.Nullable(Of Integer), ByVal Original_PrinterID As Integer, ByVal Original_Name As String, ByVal Original_ConnectionString As String, ByVal Original_Make As String, ByVal Original_Model As String, ByVal Original_IPAddress As String, ByVal Original_Location As Global.System.Nullable(Of Integer)) As Integer
            Return Me.Update(Name, ConnectionString, Make, Model, IPAddress, Location, Original_PrinterID, Original_Name, Original_ConnectionString, Original_Make, Original_Model, Original_IPAddress, Original_Location, Original_PrinterID)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function GetConnectionString(ByVal PrinterID As Integer) As String
            Dim command As Global.System.Data.SqlClient.SqlCommand = Me.CommandCollection(1)
            command.Parameters(0).Value = CType(PrinterID,Integer)
